...
- The web chat shows the latest compacted global context snapshot above the chat history, refreshes it from the latest reply, and lets the operator expand or collapse the block on demand.
