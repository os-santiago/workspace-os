...
- Long-run cycles write execution journals under the workspace memory root so each run preserves story, code metrics, functional metrics, and checkpoint history for later analysis.
