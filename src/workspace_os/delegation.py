...
def build_hardened_delegate_prompt(
    ...
    lines = [
        ...
        "- Keep one objective, atomic changes, and preserve unrelated local changes. Do not mix unrelated refactor, feature, docs, and infrastructure work.",
        ...
        "- Validate the narrowest meaningful surface that proves the change. Report scope, changed files, validation, and rollback notes.",
        "",
        ...
        "- Verify no regressions in related functionality and review diff carefully before commit",
        "",
        "First-Time Right Standard:",
        "- Understand existing code thoroughly before changing. Follow existing test patterns.",
        "- Add comprehensive error handling and test edge cases manually.",
